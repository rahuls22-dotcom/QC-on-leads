...
// during static prerender — see /agents?create=1&onboarding=1
// deep-link flow.
...
function AgentsMvpInner() {
  ...
  // Deep-link support — landing on /agents?create=1 auto-opens the
    ...
    <motion.div variants={stagger} initial="hidden" animate="show">
          ...
          {createMode === "select" && (
            <>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <button onClick={() => router.push("/agents/amvp-1")}
                  className="text-left p-5 rounded-card border border-border bg-white hover:border-accent hover:bg-accent/5 transition-colors duration-150">
                  <div className="flex items-center gap-2 mb-1.5">
      ...
      <motion.div variants={fadeUp} className="space-y-4">
        {agents.length === 0 ? (
          ...
          <div key={agent.id} onClick={() => router.push(`/agents/${agent.id}`)}
